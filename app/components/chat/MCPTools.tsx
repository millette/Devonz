      ...
      <div className="flex">
        ...
        >
          {!isInitialized ? (
            ...
            <div className="i-devonz:mcp text-xl"></div>
          )}
        </IconButton>
      </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  {serverEntries.length > 0 ? (
                    ...
                    <div className="py-4 text-center text-devonz-elements-textSecondary">
                ...
                <div>{error && <p className="mt-2 text-sm text-devonz-elements-icon-error">{error}</p>}</div>
              </div>
