    ...
    <div className="max-w-2xl mx-auto space-y-6">
      <section aria-labelledby="server-status-heading">
        <div className="flex justify-between items-center mb-3">
          <h2 className="text-base font-medium text-devonz-elements-textPrimary">MCP Servers Configured</h2>{' '}
          <button
          ...
          >
            {isCheckingServers ? (
              <div className="i-svg-spinners:90-ring-with-bg w-3 h-3 text-devonz-elements-loader-progress animate-spin" />
            ) : (
      ...
      <section aria-labelledby="config-section-heading">
        <h2 className="text-base font-medium text-devonz-elements-textPrimary mb-3">Configuration</h2>

        <div className="space-y-4">
          <div>
            <label htmlFor="mcp-config" className="block text-sm text-devonz-elements-textSecondary mb-2">
              Configuration JSON
            </label>
            <textarea
              id="mcp-config"
              ...
              className={cn(
                ...
                'border',
                error ? 'border-devonz-elements-icon-error' : 'border-devonz-elements-borderColor',
                'text-devonz-elements-textPrimary',
                'focus:outline-none focus:ring-1 focus:ring-devonz-elements-focus',
              )}
            />
          </div>
          <div>{error && <p className="mt-2 mb-2 text-sm text-devonz-elements-icon-error">{error}</p>}</div>
          <div>
            <label htmlFor="max-llm-steps" className="block text-sm text-devonz-elements-textSecondary mb-2">
            ...
            <input
              ...
              className="w-full px-3 py-2 text-devonz-elements-textPrimary text-sm rounded-lg bg-devonz-elements-background-depth-1 border border-devonz-elements-borderColor focus:outline-none focus:ring-1 focus:ring-devonz-elements-borderColorActive"
            />
          </div>
          <div className="mt-2 text-sm text-devonz-elements-textSecondary">
            ...
            <a
              ...
              className="text-devonz-elements-link hover:underline inline-flex items-center gap-1"
            >
      ...
      <div className="flex flex-wrap justify-between gap-3 mt-6">
        <button
          ...
          className="px-4 py-2 rounded-lg text-sm border border-devonz-elements-borderColor
                    bg-devonz-elements-background-depth-2 text-devonz-elements-textSecondary
