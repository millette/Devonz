...
export function DataVisualization({ chats }: DataVisualizationProps) {
  ...
  const chartColors = {
    ...
    text: getThemeColor('--devonz-elements-textPrimary'),
    textSecondary: getThemeColor('--devonz-elements-textSecondary'),
    background: getThemeColor('--devonz-elements-bg-depth-1'),
    accent: getThemeColor('--devonz-elements-button-primary-text'),
    border: getThemeColor('--devonz-elements-borderColor'),
  };
  ...
  if (chats.length === 0) {
    return (
      <div className="text-center py-8">
        <div className="i-ph-chart-line-duotone w-12 h-12 mx-auto mb-4 text-devonz-elements-textTertiary opacity-80" />
        <h3 className="text-lg font-medium text-devonz-elements-textPrimary mb-2">No Data Available</h3>
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className={cardClasses}>
          <h3 className="text-lg font-medium text-devonz-elements-textPrimary mb-6">Chat History</h3>
          <div className="h-64">
        ...
        <div className={cardClasses}>
          <h3 className="text-lg font-medium text-devonz-elements-textPrimary mb-6">Message Distribution</h3>
          <div className="h-64">
      ...
      {apiKeyUsage.length > 0 && (
        <div className={cardClasses}>
          <h3 className="text-lg font-medium text-devonz-elements-textPrimary mb-6">API Usage by Provider</h3>
          <div className="h-64">
